...

{
    ...
    "category": "Function",
    "text": "calculate_mortar_assembly(elements::Dict{Int, Vector{Int}},\n                          element_types::Dict{Int, Symbol},\n                          coords::Dict{Int, Vector{Float64}},\n                          slave_element_ids::Vector{Int},\n                          master_element_ids::Vector{Int})\n\nGiven data, calculate projection matrix P. This is the main function of package.\n\nMatrix P is defined as a projection between slave and master surface, i.e.\n\n    D u_s = M u_m Rightarrow u_s = D^-1 M u_m = P u_m\n\n\n\n"
},
